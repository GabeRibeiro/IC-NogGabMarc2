...
Definition at line \mbox{\hyperlink{ImageCodec_8cpp_source_l00169}{169}} of file \mbox{\hyperlink{ImageCodec_8cpp_source}{Image\+Codec.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00169                                             \{}
\DoxyCodeLine{00170     \mbox{\hyperlink{classbitstream}{bitstream}} bss((\textcolor{keywordtype}{char}*) fname.data(), std::ios::binary|std::ios::in);}
\DoxyCodeLine{00171     \mbox{\hyperlink{classGolomb}{Golomb}} gb(11);}
\DoxyCodeLine{00172     vector<int> hdr = gb.readHdr(4, bss);}
\DoxyCodeLine{00173     gb.set\_m(hdr[0]);}
\DoxyCodeLine{00174     \textcolor{keywordtype}{int} rows = hdr[1], cols = hdr[2];}
\DoxyCodeLine{00175     set\_function(hdr[3]);}
\DoxyCodeLine{00176     cout << \textcolor{stringliteral}{"{}Read header"{}} << endl;}
\DoxyCodeLine{00177 }
\DoxyCodeLine{00178     vector<int> g\_rd = gb.read(3*rows*cols/2, bss);}
\DoxyCodeLine{00179 }
\DoxyCodeLine{00180     Mat y = Mat::zeros(rows, cols, CV\_8UC1);}
\DoxyCodeLine{00181     Mat u = Mat::zeros(rows/2, cols/2, CV\_8UC1);}
\DoxyCodeLine{00182     Mat v = Mat::zeros(rows/2, cols/2, CV\_8UC1);}
\DoxyCodeLine{00183 }
\DoxyCodeLine{00184     cout << \textcolor{stringliteral}{"{}Read yuv"{}} << endl;}
\DoxyCodeLine{00185     vector<int> y\_(\&g\_rd[0], \&g\_rd[rows*cols-\/1]);}
\DoxyCodeLine{00186     vector<int> u\_(\&g\_rd[rows*cols], \&g\_rd[5*rows*cols/4-\/1]);}
\DoxyCodeLine{00187     vector<int> v\_(\&g\_rd[5*rows*cols/4], \&g\_rd[3*rows*cols/2-\/1]);}
\DoxyCodeLine{00188 }
\DoxyCodeLine{00189     predictive\_decoding(y, y\_);}
\DoxyCodeLine{00190     predictive\_decoding(u, u\_);}
\DoxyCodeLine{00191     predictive\_decoding(v, v\_);}
\DoxyCodeLine{00192 }
\DoxyCodeLine{00193     cv::imshow(\textcolor{stringliteral}{"{}new y"{}}, y);}
\DoxyCodeLine{00194     cv::imshow(\textcolor{stringliteral}{"{}new u"{}}, u);}
\DoxyCodeLine{00195     cv::imshow(\textcolor{stringliteral}{"{}new v"{}}, v);}
\DoxyCodeLine{00196     \mbox{\hyperlink{classImageCodec_a44478e97bd6fe6e8601b006ff02d0641}{yuv2rgb}}(rgb, y, u, v);}
\DoxyCodeLine{00197 }
\DoxyCodeLine{00198     bss.close();}
\DoxyCodeLine{00199 \}}
...
\DoxyCodeLine{00111     }
\DoxyCodeLine{00112     vector<int> y\_ = predictive\_coding(y);}
\DoxyCodeLine{00113     vector<int> u\_ = predictive\_coding(u);}
\DoxyCodeLine{00114     vector<int> v\_ = predictive\_coding(v);}
\DoxyCodeLine{00115     }
...
\DoxyCodeLine{00133     cout << \textcolor{stringliteral}{"{}write header"{}} << endl;}
\DoxyCodeLine{00134     gb.writeHdr(header, bss);}
\DoxyCodeLine{00135 }
\DoxyCodeLine{00136     cout << \textcolor{stringliteral}{"{}Write yuv"{}} << endl;}
\DoxyCodeLine{00137     gb.write(y\_, bss);}
\DoxyCodeLine{00138     gb.write(u\_, bss);}
\DoxyCodeLine{00139     gb.write(v\_, bss);}
\DoxyCodeLine{00140     bss.padding();}
\DoxyCodeLine{00141     bss.close();}
\DoxyCodeLine{00142 \}}
...
\DoxyCodeLine{00086                 \textcolor{keywordflow}{case} 0: px = non\_linear\_jpegls(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00087                 \textcolor{keywordflow}{case} 1: px = linear\_jpeg\_mode1(a); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00088                 \textcolor{keywordflow}{case} 2: px = linear\_jpeg\_mode2(b); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00089                 \textcolor{keywordflow}{case} 3: px = linear\_jpeg\_mode3(c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00090                 \textcolor{keywordflow}{case} 4: px = linear\_jpeg\_mode4(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00091                 \textcolor{keywordflow}{case} 5: px = linear\_jpeg\_mode5(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00092                 \textcolor{keywordflow}{case} 6: px = linear\_jpeg\_mode6(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00093                 \textcolor{keywordflow}{case} 7: px = linear\_jpeg\_mode7(a,b); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00094             \}}
...
Definition at line \mbox{\hyperlink{ImageCodec_8cpp_source_l00144}{144}} of file \mbox{\hyperlink{ImageCodec_8cpp_source}{Image\+Codec.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00144                                                               \{}
\DoxyCodeLine{00145     \textcolor{keywordtype}{int} rw=yuv.rows, cl=yuv.cols,r,px,a,b,c;}
\DoxyCodeLine{00146     cout<< \textcolor{stringliteral}{"{} Decoding "{}}<< endl;}
\DoxyCodeLine{00147     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<rw; i++)\{}
\DoxyCodeLine{00148         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j=0; j<cl; j++)\{}
\DoxyCodeLine{00149             r = yuv\_[i*cl+j];}
\DoxyCodeLine{00150             a = j==0? 0 : yuv.at<uchar>(i, j-\/1);}
\DoxyCodeLine{00151             b = i==0? 0 : yuv.at<uchar>(i-\/1, j);}
\DoxyCodeLine{00152             c = j==0 || i==0? 0 : yuv.at<uchar>(i-\/1, j-\/1);}
\DoxyCodeLine{00153 }
\DoxyCodeLine{00154             \textcolor{keywordflow}{switch}(this-\/>function)\{}
\DoxyCodeLine{00155                 \textcolor{keywordflow}{case} 0: px = non\_linear\_jpegls(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00156                 \textcolor{keywordflow}{case} 1: px = linear\_jpeg\_mode1(a); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00157                 \textcolor{keywordflow}{case} 2: px = linear\_jpeg\_mode2(b); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00158                 \textcolor{keywordflow}{case} 3: px = linear\_jpeg\_mode3(c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00159                 \textcolor{keywordflow}{case} 4: px = linear\_jpeg\_mode4(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00160                 \textcolor{keywordflow}{case} 5: px = linear\_jpeg\_mode5(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00161                 \textcolor{keywordflow}{case} 6: px = linear\_jpeg\_mode6(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00162                 \textcolor{keywordflow}{case} 7: px = linear\_jpeg\_mode7(a,b); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00163             \}}
\DoxyCodeLine{00164             yuv.at<uchar>(i, j) = px+r;}
\DoxyCodeLine{00165         \}}
\DoxyCodeLine{00166     \}}
\DoxyCodeLine{00167 \}}
