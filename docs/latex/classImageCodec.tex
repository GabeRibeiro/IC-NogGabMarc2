...
\DoxyCodeLine{00183 }
\DoxyCodeLine{00184 }
\DoxyCodeLine{00185     cout << \textcolor{stringliteral}{"{}Read yuv"{}} << endl;}
\DoxyCodeLine{00186     vector<int> y\_(\&g\_rd[0], \&g\_rd[rows*cols-\/1]);}
\DoxyCodeLine{00187     vector<int> u\_(\&g\_rd[rows*cols], \&g\_rd[5*rows*cols/4-\/1]);}
\DoxyCodeLine{00188     vector<int> v\_(\&g\_rd[5*rows*cols/4], \&g\_rd[3*rows*cols/2-\/1]);}
\DoxyCodeLine{00189 }
\DoxyCodeLine{00190     \mbox{\hyperlink{classImageCodec_a5750c21638fce05ccbd351dd1bd96d78}{predictive\_decoding}}(y, y\_);}
\DoxyCodeLine{00191     \mbox{\hyperlink{classImageCodec_a5750c21638fce05ccbd351dd1bd96d78}{predictive\_decoding}}(u, u\_);}
\DoxyCodeLine{00192     \mbox{\hyperlink{classImageCodec_a5750c21638fce05ccbd351dd1bd96d78}{predictive\_decoding}}(v, v\_);}
\DoxyCodeLine{00193 }
\DoxyCodeLine{00194     cv::imshow(\textcolor{stringliteral}{"{}new y"{}}, y);}
\DoxyCodeLine{00195     cv::imshow(\textcolor{stringliteral}{"{}new u"{}}, u);}
\DoxyCodeLine{00196     cv::imshow(\textcolor{stringliteral}{"{}new v"{}}, v);}
\DoxyCodeLine{00197     \mbox{\hyperlink{classImageCodec_a44478e97bd6fe6e8601b006ff02d0641}{yuv2rgb}}(rgb, y, u, v);}
\DoxyCodeLine{00198 }
\DoxyCodeLine{00199     bss.close();}
\DoxyCodeLine{00200 \}}
...
\DoxyCodeLine{00155                 \textcolor{keywordflow}{case} 0: px = \mbox{\hyperlink{classImageCodec_a127e953b9ab923721cc00961878c0f2e}{non\_linear\_jpegls}}(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00156                 \textcolor{keywordflow}{case} 1: px = \mbox{\hyperlink{classImageCodec_a6017a41ddb56bb66202a85e1b3e99e17}{linear\_jpeg\_mode1}}(a); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00157                 \textcolor{keywordflow}{case} 2: px = \mbox{\hyperlink{classImageCodec_a8dd5e8dd4bb5788513ded48f6e16cb6f}{linear\_jpeg\_mode2}}(b); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00158                 \textcolor{keywordflow}{case} 3: px = \mbox{\hyperlink{classImageCodec_aedbdc99285a2aa8b91e33596658fc440}{linear\_jpeg\_mode3}}(c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00159                 \textcolor{keywordflow}{case} 4: px = \mbox{\hyperlink{classImageCodec_a79615da6e84257a938b84cabf338848b}{linear\_jpeg\_mode4}}(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00160                 \textcolor{keywordflow}{case} 5: px = \mbox{\hyperlink{classImageCodec_a54f87b912c6652528405cfd8f78792a8}{linear\_jpeg\_mode5}}(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00161                 \textcolor{keywordflow}{case} 6: px = \mbox{\hyperlink{classImageCodec_aeffd813de962daae740980a06781a4eb}{linear\_jpeg\_mode6}}(a,b,c); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00162                 \textcolor{keywordflow}{case} 7: px = \mbox{\hyperlink{classImageCodec_a11c1e2cc2521efe6d6cacfb3a4c63247}{linear\_jpeg\_mode7}}(a,b); \textcolor{keywordflow}{break};}
\DoxyCodeLine{00163             \}}
