...
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00024}00024 \textcolor{keywordtype}{double} AudioCodec::entropy(vector<int> vec)\{}
...
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00041}00041 vector<int> AudioCodec::predictive\_coding(vector<int> aud)\{}
...
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00061}00061 \textcolor{keywordtype}{void} AudioCodec::encode(\textcolor{keywordtype}{string} fname, \textcolor{keywordtype}{char} \textcolor{keyword}{const}* wav)\{}
...
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00078}00078         rcnl[i] = predictive\_coding(vcnl[i]);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00079}00079     }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00080}00080     vector<int> map;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00081}00081     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<sfinfo.channels; i++)}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00082}00082         transform(rcnl[i].begin(), rcnl[i].end(), back\_inserter(map),  }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00083}00083         [](\textcolor{keywordtype}{int} x) \{ \textcolor{keywordflow}{return}  abs(x); \});  }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00084}00084     \textcolor{keywordtype}{double} mean=accumulate(map.begin(), map.end(), 0);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00085}00085     mean/= sfinfo.channels*sfinfo.frames;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00086}00086 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00087}00087     \mbox{\hyperlink{classGolomb}{Golomb}} gb(  ceil(-\/1/log2(mean/(mean+1))) );}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00088}00088 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00089}00089     \mbox{\hyperlink{classbitstream}{bitstream}} bss((\textcolor{keywordtype}{char}*) fname.data(), std::ios::binary|std::ios::out);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00090}00090     }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00091}00091     vector<int> hdr;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00092}00092     hdr.push\_back(gb.get\_m());          \textcolor{comment}{//m de golomb}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00093}00093     hdr.push\_back(sfinfo.channels);     \textcolor{comment}{//numero de canais}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00094}00094     hdr.push\_back(sfinfo.frames);       \textcolor{comment}{//numero de samples}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00095}00095     hdr.push\_back(sfinfo.format);       \textcolor{comment}{//formato}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00096}00096     hdr.push\_back(sfinfo.samplerate);   \textcolor{comment}{//samplerate}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00097}00097     hdr.push\_back(order);               \textcolor{comment}{//ordem}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00098}00098     gb.writeHdr(hdr, bss);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00099}00099 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00100}00100     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<sfinfo.channels; i++)}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00101}00101         gb.write(rcnl[i], bss);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00102}00102     bss.padding();}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00103}00103 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00104}00104     sf\_close(snd);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00105}00105 \}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00106}00106 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00107}00107 vector<int> AudioCodec::predictive\_decoding(vector<int> rsd)\{}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00108}00108     \textcolor{keywordtype}{int} px, x1=0, x2=0, x3=0;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00109}00109     vector<int> v;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00110}00110     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i =0; i<(int)rsd.size(); i++)\{}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00111}00111         \textcolor{keywordflow}{switch}(order)\{}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00112}00112             \textcolor{keywordflow}{case} 1: px = x1; \textcolor{keywordflow}{break};}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00113}00113             \textcolor{keywordflow}{case} 2: px = 2*x1 -\/ x2; \textcolor{keywordflow}{break};}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00114}00114             \textcolor{keywordflow}{case} 3: px = 3*x1 -\/ 3*x2 + x3; \textcolor{keywordflow}{break};}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00115}00115         \}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00116}00116         v.push\_back(px+rsd[i]);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00117}00117         x3=x2;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00118}00118         x2=x1;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00119}00119         x1=v[i];}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00120}00120     \}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00121}00121     \textcolor{keywordflow}{return} v;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00122}00122 \}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00123}00123 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00124}00124 \textcolor{keywordtype}{void} AudioCodec::decode(\textcolor{keywordtype}{string} fname, \textcolor{keywordtype}{char} \textcolor{keyword}{const}* wav)\{}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00125}00125     \mbox{\hyperlink{classbitstream}{bitstream}} bss((\textcolor{keywordtype}{char}*) fname.data(), std::ios::binary|std::ios::in);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00126}00126     \mbox{\hyperlink{classGolomb}{Golomb}} gb(10);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00127}00127     }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00128}00128     vector<int> hdr = gb.readHdr(6, bss);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00129}00129 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00130}00130     gb.set\_m(hdr[0]);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00131}00131     order = hdr[5];}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00132}00132 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00133}00133     SF\_INFO sfinfo;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00134}00134     sfinfo.channels = hdr[1];}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00135}00135     sfinfo.format = hdr[3];}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00136}00136     sfinfo.samplerate = hdr[4];}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00137}00137     cout << \textcolor{stringliteral}{"{}format :  "{}}<< sfinfo.format <<endl;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00138}00138 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00139}00139 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00140}00140     vector<int> rcnl[hdr[1]], vcnl[hdr[1]];}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00141}00141     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<hdr[1]; i++)\{}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00142}00142         rcnl[i] = gb.read(hdr[2], bss);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00143}00143         vcnl[i] = predictive\_decoding(rcnl[i]);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00144}00144     \}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00145}00145 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00146}00146     vector<short> wrt;}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00147}00147     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0; i<(int)vcnl[0].size(); i++)\{}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00148}00148         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j=0; j<sfinfo.channels; j++)}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00149}00149             wrt.push\_back((\textcolor{keywordtype}{short})vcnl[j][i]);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00150}00150     \}}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00151}00151 }
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00152}00152     SNDFILE * outfile = sf\_open(wav, SFM\_WRITE, \&sfinfo);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00153}00153     sf\_count\_t count = sf\_write\_short(outfile, \&wrt[0], hdr[1]*hdr[2]);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00154}00154     sf\_write\_sync(outfile);}
\DoxyCodeLine{\Hypertarget{AudioCodec_8cpp_source_l00155}00155     sf\_close(outfile);}
